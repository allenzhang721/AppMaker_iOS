...
-(void) update
{
    ...
    {
        self.coverImg = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"TW_image_morenfengmian"]] autorelease];
...
//        [self.progressView setTintColor:[UIColor whiteColor]];
    ...
    self.coverImg.image = [UIImage imageNamed:@"TW_image_morenfengmian"];
