...
//------------------------
@property (nonatomic, strong) UIImage *backgroundImage UI_APPEARANCE_SELECTOR;              //Mr.chen
@property (nonatomic, strong) UIImage *buttonBackgroundImage UI_APPEARANCE_SELECTOR;        //Mr.chen
...
- (NSInteger)addButtonWithTitle:(NSString *)title sideLeft:(BOOL)left;      //Mr.chen
