...
@property (nonatomic, retain, readwrite) NSNumberFormatter *numberFormatter;

@property (nonatomic, assign, readwrite) UILabel *valueLabel;
@property (nonatomic, assign, readwrite) UIView *stopView;
