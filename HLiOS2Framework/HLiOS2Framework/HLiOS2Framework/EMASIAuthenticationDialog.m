...
#import "EMASIAuthenticationDialog.h"
#import "ASIHTTPRequest.h"
#import <QuartzCore/QuartzCore.h>

static EMASIAuthenticationDialog *sharedDialog = nil;
...
@implementation EMASIAutorotatingViewController
...
@interface EMASIAuthenticationDialog ()
- (void)showTitle;
- (void)show;
...
@implementation EMASIAuthenticationDialog

#pragma mark init / dealloc

+ (void)initialize
{
	if (self == [EMASIAuthenticationDialog class]) {
...
- (UIViewController *)presentingController
{
	if (!presentingController) {
		presentingController = [[EMASIAutorotatingViewController alloc] initWithNibName:nil bundle:nil];
