...
@implementation HLSliderCoverContainerController
...
- (void)initFrame:(HLPageViewController *)curPageController isCurPage:(BOOL)isCurPage isRight:(BOOL)isRight
{
    for (HLContainer *container in curPageController.pageController.objects) {
...
- (void)resetFrame:(HLPageViewController *)curPageController posChange:(TAnimationEndPos)posChange
{
    //    NSLog(@"resetFrame");
    for (HLContainer *container in curPageController.pageController.objects)
    {
