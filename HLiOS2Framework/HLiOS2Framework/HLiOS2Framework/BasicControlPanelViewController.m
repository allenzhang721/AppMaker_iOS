...
@interface BasicControlPanelViewController ()

@end

@implementation BasicControlPanelViewController
...
-(void) setup:(CGRect )rect
{
    ...
    //SnapShotButton
    {
        ButtonEntity *btn =self.bookController.entity.snapBtn;
    ...
    {
        ButtonEntity *btn = self.bookController.entity.exitBtn;
        
    }
    
    //  HomeButton
    {
        ButtonEntity *btn = self.bookController.entity.homeBtn;
        if((self.bookController.entity.isVerHorMode == YES) && (self.orientation != -1))
        {
            if ((self.orientation == UIInterfaceOrientationPortrait) || (self.orientation == UIInterfaceOrientationPortraitUpsideDown))
            {
    ...
    //  RightButton
    {
        ButtonEntity *btn = self.bookController.entity.rightBtn;
        if((self.bookController.entity.isVerHorMode == YES) && (self.orientation != -1))
        {
            if ((self.orientation == UIInterfaceOrientationPortrait) || (self.orientation == UIInterfaceOrientationPortraitUpsideDown))
            {
    ...
    //  LeftButton
    {
        ButtonEntity *btn = self.bookController.entity.leftBtn;
        if((self.bookController.entity.isVerHorMode == YES) && (self.orientation != -1))
        {
            if ((self.orientation == UIInterfaceOrientationPortrait) || (self.orientation == UIInterfaceOrientationPortraitUpsideDown))
            {
...
//    self.btnExit.frame = CGRectMake(rect.size.width/2 - CGRectGetWidth(self.btnExit.frame), 0, CGRectGetWidth(self.btnExit.frame) * rate, CGRectGetHeight(self.btnExit.frame) *rate);
    ...
    //  BgMusicButton
    {
        ButtonEntity *btn =self.bookController.entity.bgMusicBtn;
        if((self.bookController.entity.isVerHorMode == YES) && (self.orientation != -1))
        {
            if ((self.orientation == UIInterfaceOrientationPortrait) || (self.orientation == UIInterfaceOrientationPortraitUpsideDown))
            {
    ...
    //  SearchButton
    {
        ButtonEntity *btn =self.bookController.entity.searchBtn;
        if  (btn)
        {
