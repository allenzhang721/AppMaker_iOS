...
@class HLMagazinePopupViewController;
@interface HLSharePopupViewController : UIViewController
{}
...
@property (nonatomic,assign) HLMagazinePopupViewController *mpViewController;
-(void) setup;
@end
