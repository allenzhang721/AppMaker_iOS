...
@property (nonatomic, assign) BOOL uniformScoll;        //liwei add
@property (nonatomic, readonly) NSTimeInterval startTime;   //liwei add
@property (nonatomic, readonly) NSTimeInterval scrollDuration;  //liwei add
