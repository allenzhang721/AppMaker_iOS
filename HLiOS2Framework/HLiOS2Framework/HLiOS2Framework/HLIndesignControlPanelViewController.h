...
@interface HLIndesignControlPanelViewController : HLBaseControlPanelViewController <UIScrollViewDelegate, SliderViewDelegate, CollectionDelegate, CatalogueDelegate, SearchDelegate>
{
    BOOL        _isPoped;
    ...
    HLIndesignSliderView  *_sliderView;
    CatalogueTableView  *_catalogueTableView;
    HLCollectionTableView *_collectionTableView;
    HLIndesignSearchTableView *_indesignSearchTableView;
