...
{
    UIImage *crop = [ViewCrop crop:self.pageController.pageViewController.view :CGRectMake(0, 0, [self.pageController.currentPageEntity.width floatValue], [self.pageController.currentPageEntity.height floatValue])];
