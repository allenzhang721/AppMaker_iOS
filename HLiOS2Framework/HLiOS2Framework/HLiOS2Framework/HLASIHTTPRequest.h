...
@class HLASIDataDecompressor;

extern NSString *ASIHTTPRequestVersionHL;
...
extern NSString* const NetworkRequestErrorDomainHL;
...
extern unsigned long const ASIWWANBandwidthThrottleAmountHL;
...
@interface HLASIHTTPRequest : NSOperation <NSCopying> {
	...
	HLASIDataDecompressor *dataDecompressor;
	...
	HLASIHTTPRequest *PACFileRequest;
...
@property (assign) HLASIHTTPRequest *mainRequest;
...
#endif
@property (retain) HLASIDataDecompressor *dataDecompressor;
