...
@implementation ConnectLineEntity
...
-(void) decodeData:(TBXMLElement *)data
{
    ...
    {
        TBXMLElement *subElement = [EMTBXML childElementNamed:@"LeftCell"parentElement:row];
        if (subElement)
        {
        ...
        subElement = [EMTBXML childElementNamed:@"RightCell"parentElement:row];
        if (subElement)
        {
            TBXMLElement *id = [EMTBXML childElementNamed:@"CellID"parentElement:subElement];
            TBXMLElement *linkId = [EMTBXML childElementNamed:@"LinkID"parentElement:subElement];
