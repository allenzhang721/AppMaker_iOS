...
@interface HLIndesignControlPanelViewController ()

@end

@implementation HLIndesignControlPanelViewController
...
- (void)viewDidLoad
{
    ...
    if (isShowSearch)
    {
        ...
        _indesignSearchTableView = [[HLIndesignSearchTableView alloc] initWithFrame:CGRectZero];
...
//    _bottomControlPanel.hidden = YES;
    ...
    _sliderView = [[[HLIndesignSliderView alloc] initWithFrame:CGRectMake(0, 0, 1024, 44)] autorelease];
