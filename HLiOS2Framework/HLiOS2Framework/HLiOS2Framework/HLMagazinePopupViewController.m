...
#import "HLSharePopupViewController.h"

@interface HLMagazinePopupViewController ()

@end

@implementation HLMagazinePopupViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HLSharePopupViewController *sp = [[[HLSharePopupViewController alloc] init] autorelease];
