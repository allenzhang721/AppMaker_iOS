...
@implementation HLSliderContainerController
...
- (void)initFrame:(HLSliderPageController *)curPageController isCurPage:(BOOL)isCurPage isRight:(BOOL)isRight
{
//    NSLog(@"initFrame: isCurPage isRight");
    for (HLContainer *container in curPageController.currentPageController.objects) {
...
- (void)resetFrame:(HLSliderPageController *)curPageController posChange:(AnimationEndPos)posChange
{
//    NSLog(@"resetFrame");
    for (HLContainer *container in curPageController.currentPageController.objects)
    {
