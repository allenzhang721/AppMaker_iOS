...
-(void) decode:(NSString *) xml
{
    ...
    EMTBXML* tbxml = [[EMTBXML newTBXMLWithXMLString:xml error:nil] autorelease];
    TBXMLElement *root = tbxml.rootXMLElement;
    if (root)
    {
        TBXMLElement *xmlIndexs = [EMTBXML childElementNamed:@"xmlIndex" parentElement:root];
        while (xmlIndexs != nil)
        {
            HLXMLItem *item = [[HLXMLItem alloc] init];
            item.itemid   = [EMTBXML textForElement:[EMTBXML childElementNamed:@"id" parentElement:xmlIndexs]];
            item.start    = [[EMTBXML textForElement:[EMTBXML childElementNamed:@"startnumber" parentElement:xmlIndexs]] intValue];
            item.end      = [[EMTBXML textForElement:[EMTBXML childElementNamed:@"endnumber" parentElement:xmlIndexs]] intValue];
            xmlIndexs = [EMTBXML nextSiblingNamed:@"xmlIndex" searchFromElement:xmlIndexs];
...
-(HLXMLItem *) getXMLItem:(NSString *) itemid
{
    ...
    {
        HLXMLItem *item =  [self.items objectAtIndex:i];
...
{
    NSString *retStr = @"";
    HLXMLItem *item = [self getXMLItem:itemid];
    if (item) {
