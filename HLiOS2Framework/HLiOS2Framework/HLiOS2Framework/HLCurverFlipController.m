...
@interface HLCurverFlipController ()
{
    BOOL isChangeCover;
}
...
@implementation HLCurverFlipController
...
//        [self.pageController beginView];
        ...
        NSString *coverResourceID = ((HLsingleCoverController *)self.coverController).pageController.pageViewController.pageEntity.background.dataid;
...
- (void)confireGotoPage:(int)index animate:(Boolean)animate
{
    ...
    HLPageEntity *ChangeTopageEntity    = [HLPageDecoder decode:changeToPageid path:self.rootPath];
