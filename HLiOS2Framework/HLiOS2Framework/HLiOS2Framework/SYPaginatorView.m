...
- (id)initWithFrame:(CGRect)frame {
	if ((self = [super initWithFrame:frame])) {
		...
		// Scroll view
		_scrollView = [[[SYPaginatorScrollView alloc] initWithFrame:self.bounds] autorelease];
		...
		_pageControl = [[[SYPageControl alloc] initWithFrame:CGRectMake(0.0f, size.height - 18.0f, size.width, 18.0f)]autorelease];
