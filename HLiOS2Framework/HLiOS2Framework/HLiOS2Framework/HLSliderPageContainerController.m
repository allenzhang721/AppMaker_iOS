...
@implementation HLSliderPageContainerController
...
- (void)initFrame:(HLPageController *)curPageController isCurPage:(BOOL)isCurPage isRight:(BOOL)isRight
{
    for (HLContainer *container in curPageController.objects) {
...
- (void)resetFrame:(HLPageController *)curPageController posChange:(AnimationEndPos)posChange
{
    for (HLContainer *container in curPageController.objects)
    {
        if (container.entity.isUseSlide && !container.entity.isPageInnerSlide)
